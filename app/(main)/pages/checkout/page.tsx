...
function CheckoutContent() {
  ...
  const plan: PlanKey =
    planParam && planParam in plans ? (planParam as PlanKey) : "BASIC";
  ...
  const handleCheckout = async () => {
    if (!user) {
      setError("Please log in before continuing.");
      return;
    }
    ...
    try {
      ...
      setError(
        err?.response?.data?.error || "Unable to start checkout."
      );
      setLoading(false);
    }
  };
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-default-500">
                      ...
                      Stripe. We never store your credit or debit card
                      details.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-default-500">
                      ...
                      <li>
                        Your subscription starts immediately after
                        payment.
                      </li>
                      <li>
